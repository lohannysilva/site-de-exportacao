...
<div class="conteudo">
  ...
  <div class="card">
    <img id="img1"src="{{asset('img/boneco.jpg')}}" alt="Imagem 5">
    <h3>Branca de Neve</h3>
    <p>R$ 25,00</p>
    <a href="{{ route('produtos.show', ['produto' => 7]) }}" class="btn btn-dark">Ver detalhes</a>
  </div>
  <div class="card">
    <img id="img1"src="{{asset('img/feia.jpg')}}" alt="Imagem 5">
    <h3>Ratinho</h3>
    <p>R$ 25,00</p>
